...
import { Bell, BellRing, Bookmark, Eye, History, LayoutDashboard, Lock, LogOut, MessageCircle, PenLine, ShieldCheck, UserRound } from 'lucide-react'
...
export async function AccountTopbar() {
  ...
  const tabs = [
    ...
    },
    {
      ...
      label: dict.account.topbar.profile,
      icon: UserRound,
    },
    {
    ...
    },
    {
      ...
      label: dict.account.topbar.messages,
      icon: MessageCircle,
    },
    {
      href: localePath(locale, '/account/security'),
      label: dict.account.topbar.security,
      icon: Lock,
    },
    {
